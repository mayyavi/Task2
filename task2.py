...
import pandas as pd
data = pd.read_csv('C:\\Users\\ALPHA\\Downloads\\01.Data Cleaning and Preprocessing.csv')
type(data)
...
AttributeError: 'DataFrame' object has no attribute 'isull'. Did you mean: 'isnull'?
data.isnull().sum().sum()
np.int64(352)
...
Traceback (most recent call last):
  File "<pyshell#37>", line 1, in <module>
    data2=data2[~((data2<(Q1-1.5*IQR))|(data2>ArithmeticError(Q3+1.5*IQR))).any(axis=1)]
  File "C:\Program Files\Python312\Lib\site-packages\pandas\core\ops\common.py", line 76, in new_method
    return method(self, other)
  File "C:\Program Files\Python312\Lib\site-packages\pandas\core\arraylike.py", line 56, in __gt__
    return self._cmp_method(other, operator.gt)
  File "C:\Program Files\Python312\Lib\site-packages\pandas\core\frame.py", line 7900, in _cmp_method
    new_data = self._dispatch_frame_op(other, op, axis=axis)
  File "C:\Program Files\Python312\Lib\site-packages\pandas\core\frame.py", line 7945, in _dispatch_frame_op
    bm = self._mgr.apply(array_op, right=right)
  File "C:\Program Files\Python312\Lib\site-packages\pandas\core\internals\managers.py", line 361, in apply
    applied = b.apply(f, **kwargs)
  File "C:\Program Files\Python312\Lib\site-packages\pandas\core\internals\blocks.py", line 393, in apply
    result = func(self.values, **kwargs)
  File "C:\Program Files\Python312\Lib\site-packages\pandas\core\ops\array_ops.py", line 347, in comparison_op
    res_values = _na_arithmetic_op(lvalues, rvalues, op, is_cmp=True)
  File "C:\Program Files\Python312\Lib\site-packages\pandas\core\ops\array_ops.py", line 218, in _na_arithmetic_op
    result = func(left, right)
  File "C:\Program Files\Python312\Lib\site-packages\pandas\core\computation\expressions.py", line 242, in evaluate
    return _evaluate(op, op_str, a, b)  # type: ignore[misc]
  File "C:\Program Files\Python312\Lib\site-packages\pandas\core\computation\expressions.py", line 73, in _evaluate_standard
    return op(a, b)
